...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-brand-purple-muted via-white to-purple-50 px-4">
      {/* Subtle background accent */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 h-80 w-80 rounded-full bg-brand-purple/5 blur-3xl" />
        <div className="absolute -bottom-40 -left-40 h-80 w-80 rounded-full bg-brand-fuchsia/5 blur-3xl" />
      </div>

      <div className="relative w-full max-w-sm">
        <div className="card-elevated rounded-3xl bg-white/90 backdrop-blur-sm p-8">
          {/* Logo */}
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-semibold tracking-tight text-brand-purple-deep">
              PickUp Time
            </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                className="h-11 rounded-xl border-border/60 bg-white focus:border-brand-purple focus:ring-brand-purple/20"
                required
              />
            </div>
            <div className="space-y-1.5">
